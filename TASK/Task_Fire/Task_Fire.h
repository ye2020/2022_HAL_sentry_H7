...
#define FRICTION_THREE_SHOOT_SPEED   1230//(2000 - 1160) 	//1070  //	1400				//(2000 - 1215)//   24 m/s// (2000 - 1205) //30摩擦轮高速pwm			1205 -> 22.5m/s     (1243)
#define FRICTION_ONE_SHOOT_SPEED   	 1187///(2000- 1140)//(2000 - 1160)	//1000 //	1298					//(2000 - 1160)//(2000 - 1187)       //18摩擦轮高速pwm		原1173  13.5m/s			（1187）
#define FRICTION_SHOOT_STOP          1000//(2000 - 880) 	//  	800						//	(2000 - 1000)       //0摩擦轮停止pwm
